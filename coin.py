...
class CoinDataset(utils.Dataset):
    ...
    def load_coin(self, dataset_dir, subset):
        ...
        self.add_class("coin", 1, "one")
        self.add_class("coin", 2, "five")
        self.add_class("coin", 3, "ten")
        ...
        for a in annotations:
            ...
            #    masks = [r['shape_attributes'] for r in a['regions'].values()]
            #else:
            #    masks = [r['shape_attributes'] for r in a['regions']]
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        for i, r in enumerate(info["regions"]):
            ...
            # polyline, ellipse, circle.....
            p = r["shape_attributes"]
            shape_type = r["shape_attributes"]["name"]
            class_id = self.find_class_id(r["region_attributes"]["coin"])
            class_ids.append(class_id)
            if shape_type == "polyline":
                rr, cc = skimage.draw.polygon(p['all_points_y'], p['all_points_x'])
                mask[rr, cc, i] = class_id
